    ...
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 ">
               ...
               @foreach($productos as $producto)
                ...
                <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                       <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12"  style="background: #FF0000">     
                           <h5 style="color: white">{{$producto->nombre}} {{$producto->preciounidad}} BS.</h5>
                      </div>
                      <img src="{{asset('imagenes/productos/'.$producto->imagen)}}" alt="{{$producto->nombre}}" height="400px" width="300px" class="img-thumbnail">
