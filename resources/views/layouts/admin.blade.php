    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="index2.html" class="logo">
          ...
          <span class="logo-lg"><b>PANADERIA</b></span>
        </a>
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span class="hidden-xs">Bladimir Toco</span>
                </a>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
             ...
             <li class="treeview">
              ...
              <ul class="treeview-menu">
                 <li><a href="<?php echo url('atender/atendido')?>"><i class="fa fa-circle-o"></i>Peidos</a></li>
               </li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="<?php echo url('almacen/transporte')?>"><i class="fa fa-circle-o"></i>Transporte></li>
                  <li><a href="<?php echo url('ventas/venta')?>"><i class="fa fa-circle-o"></i>Transporte></li>
              </ul>
            </li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
               <li><a href="<?php echo url('usuario/cliente')?>"><i class="fa fa-circle-o"></i>Cliente></li>
                <li><a href="<?php echo url('usuario/proveedor')?>"><i class="fa fa-circle-o"></i>Proveedor></li>
              </ul>
      ...
      <footer class="main-footer">
        ...
        <strong>tecnologia web grupo 07 2019-2020 <a href="www.incanatoit.com">Panaderia las TOXOS</a>.</strong> .
      </footer>
